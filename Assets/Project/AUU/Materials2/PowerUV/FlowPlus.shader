    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float2 node_1038 = (i.uv0+_control*float2(0,0.3));
                float node_3584 = step(abs(((node_1038*_delay).g-0.5)),0.25);
                clip(node_3584 - 0.5);
////// Lighting:
////// Emissive:
                float4 node_8320 = _Time;
                float2 node_2249 = (i.uv0+node_8320.g*float2(0,0.1));
                float4 _node_47_var = tex2D(_node_47,TRANSFORM_TEX(node_2249, _node_47));
                float2 node_1012 = (i.uv0+node_8320.g*float2(0,0.1));

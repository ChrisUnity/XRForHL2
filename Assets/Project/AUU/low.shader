...
Shader "zhongche/low" {
    Properties {
        ...
        _RimThickness ("RimThickness", Range(0, 5)) = 0.64
        _RimColor ("RimColor", Color) = (0.098,0.8235,0.9411,1)
